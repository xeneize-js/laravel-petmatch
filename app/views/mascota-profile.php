...
<html lang = "en">
	<!-- BEGIN head -->
	<head>
		<title><?php echo $mascota["nombre"];?> | Petmatch</title>
					...
					<div class="header-right">
						<nav class="main-menu">
							<ul class="load-responsive" rel="Main Menu">
								<li><a href="/pet/lista-mascotas/<?php echo $mascota["own"];?>">Mis mascotas</a></li>
							</ul>
					...
					<!-- <div class="main-content"> -->
						...
						<div class="left-content">
							...
							<div class="main-title">
								<h2>Hola <?php echo $mascota["nombre"];?></h2>
								<span><?php echo $mascota["raza"];?></span>
								<div class="user-actions">
									<div id="iconos">
										<!--<a id="modal-start" class="" data-toggle="modal" data-target="#edit-profile-modal" href="#"><img width="20px" height="20px" src="/img/iconos/editar.png"></a>-->
									...
									<div class="column6">
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
															...
															<form id="edit-profile-form" class="form-box register-form form-validator" method="post" action="/pet/edit-pet">
																...
																<div class="form-group">
																	<label>Caracter de tu mascota : <span class="required">*</span></label><br />
																	<input id="caracter" type="text" required name="caracter">
																</div>
																<div class="form-group">
																...
																<div class="form-group" >
																	...
																	<input id="vacunas-cuales" type="text" required name="vacunas_cuales">
																</div>
																<div class="form-group" >
																	<label>Cuantas veces ha sido mama o papa? : <span class="required">*</span></label><br />
																	<input id="padre" type="text" required name="padre">
																</div>
																<div class="form-group" >
																...
																<div class="form-group" >
																	...
																	<input id="tamano" type="text" required name="tamano">
																</div>
																<div class="form-group" >
																...
																<div class="form-group">
																	<div class='input-group date' id='datetimepicker1'>
																		...
																		<input id="edad-mascota" name="edad" type='text' class="form-control" />
																...
																<div class="form-group">
																	...
																	<textarea id="datos" type="textarea" name="datos" style="margin: 0px; width: 506px; height: 133px;"></textarea>
																</div>

																<div class="buttons-box clearfix">
																	<input id="edit_pet" class="<?php echo $user[0]["uuid"];?>" type="submit" value="Editar Mascota">
										...
										<div class="accordion">
											...
											<div>
												...
												<h5><a href="/mensaje/sent/<?php echo $mascota["uuid"];?>">Mensajes enviados</a></h5>
												<div class="profile-image"><img width="150px" width="150px" src="<?php echo $image_profile[0]["path"];?>" style="float: right;position: relative; top:-40px"></div>
											</div>
							...
							<div class="home-block">
								<div class="main-title" style="border-left: 4px solid #ef8722">
									<a href="/pet/upload-picture/<?php echo $mascota["uuid"];?>/<?php echo $user[0]["uuid"];?>" class="right button" style="background: #ef8722; color: #ef8722;">Agregar imagen</a>
									<h2>Mis fotos </h2>
								</div>
							...
							<div class="home-block">
								<div class="main-title" style="border-left: 4px solid #ef8722">
									<h2>Beneficios de este mes</h2>
									<br>
									<div class="banner">
										<a class="btn btn-default" href="/beneficios/mascota/<?php echo $mascota["uuid"];?>" >Beneficios de mi mascota</a>
									</div>
						...
						<aside id="sidebar">
							...
							<div class="widget">
								<h3>Busca</h3>
													...
													<div class="subscribe-feed">
														<p>Elije que quieres buscar</p>
														<p><a class="btn btn-default" id="tab-mascota" href="javascript:void(0)">Busca Mascotas</a></p>
														<p><a class="btn btn-default" id="tab-animalista" href="javascript:void(0)">Busca Animalistas</a></p>
														...
														<form novalidate method="post" name="animalista" action="/buscador/data" id="busca-animalista">
															<div class="form-group">
																<label>Tipo de vivienda del animalista</label>
															...
															<div class="form-group">
																<label>Tamano de vivienda del animalista</label>
															...
															<div class="form-group">
																<label>En donde hospeda sus mascotas el animalista?</label>
															...
															<div class="form-group">
																<label>Tiene disponibolidad las 24 Hrs.?</label>
															...
															<div class="form-group">
																<label>En que estado prefieres buscar servicios?</label>
															...
															<div class="form-group">
																<label>En que delegacion o municipio prefieres buscar servicios?: <span class="required">*</span></label>
															...
															<div class="form-group">
																<label>En que etapa de vida esta tu mascota?</label>
															...
															<div class="form-group">
																<label>Que Personalidad tiene tu mascota?</label>
															...
															<p class="sub-submit">
																<input hidden value="1" name="animalista">
														...
														<form id="busca-mascota" novalidate method="post" name="aweber-form" action="/buscador/data" >
															<div class="form-group">
																<label>Clase de mascota: <span class="required">*</span></label>
						    ...
						    <h3>Mi calendario</h3>
								...
								<?php endforeach;?>
								<br/>
								<a  class="btn btn-default" href="/calendar/add-event/<?php echo $mascota["uuid"];?>">Agregar evento</a>
							</div>
