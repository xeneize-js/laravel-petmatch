		  ...
		  <div class="rotation">
			<div class="front-end">
			  <div class="form-content">
				<form enctype="multipart/form-data" form-box login-form form-validator" method="post" action="<?php echo $baseURL;?>pet/upload-picture">
                <h3 style="color:#ffffff" class="title">Sube una foto nueva </h3>
				  <div class="form-group">
					  <input hidden value="<?php echo $uuid;?>" name="uuid">
				  </div>
                <div class="form-group">
                  <input hidden value="<?php echo $own;?>" name="own">
                </div>
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="is_profile" value="1"> <span style="color: #ffffff">Marca este campo si quieres esta foto como perfil</span>
                  </label>
                </div>
