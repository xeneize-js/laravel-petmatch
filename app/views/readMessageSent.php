		  ...
		  <div class="rotation">
			<div class="front-end">
			  <div class="form-content">
                ...
                <h3><?php echo date("d-m-Y",strtotime($message["created"]));?></h3>
                <h5><?php echo $message["body"];?></h5>
                <a href="/mensaje/new/<?php echo $message["to"];?>/<?php echo $message["from"];?>">Enviar mensaje a la misma persona</a>
              </div>
