...
<head>
  <meta charset="utf-8">
  <title>Catalog Grid \ Progressive — Responsive Multipurpose HTML Template</title>
    ...
    <div class="row">
      <div id="catalog" class="content col-sm-12 col-md-12">
		<div class="category-img">
		  <img src="/img/content/petmatch.jpg" width="870" height="370" alt="">
		  <div class="description">Aquí es donde toda historia comienza. ¡Suerte!</div>
		</div>
		...
		<div class="toolbar clearfix">
		  ...
		  <div class="sort-catalog">
			<div class="btn-group sort-by btn-select">
			  <a class="btn dropdown-toggle btn-default" role="button" data-toggle="dropdown" href="#">Filtrar por: <span>Recientes</span> <span class="caret"></span></a>
			  <ul class="dropdown-menu">
				<li><a href="#">Edad</a></li>
		  ...
		  <div class="sort-catalog">
			<div class="btn-group show-by btn-select">
			  <a class="btn dropdown-toggle btn-default" role="button" data-toggle="dropdown" href="#">Mostrar: <span>10</span> <span class="caret"></span></a>
			  <ul class="dropdown-menu">
				<li><a href="#">1</a></li>
				<li><a href="#">2</a></li>
				<li><a href="#">3</a></li>
		...
		<?php if(isset($mascotas["mascotas"])):?>
			<?php if(empty($mascotas["mascotas"])):?>
			<h3>No produjo resultados tu busqueda</h3>
			<?php endif;?>
		<?php foreach($mascotas["mascotas"] as $key => $mascota):?>
		<div class="products grid row">
		  <div class="col-sm-3 col-md-3 product rotation">
			  ...
			  <div class="product-description">
				<div class="vertical">
				  <h3 class="product-name">
					  <?php //print_r($mascota);die;?>
					<a href="shop-product-view.html"><?php echo $mascota["name"];?></a>
				  </h3>
				  <div class="price">Pastor Alemán</div>	
				</div>
			  </div>
			</div>
			...
			<div class="product-hover">
			  ...
			  <div class="price"><?php echo $mascota["raza"];?></div>
			  <a href="shop-product-view.html" class="product-image">
				<img src="/img/content/product-1.png" alt="" title="" width="70" height="70">
			  </a>
			  <ul>
				<li><?php echo $mascota["edad"];?></li>
				<li><?php echo $mascota["ciudad"];?>, <?php echo $mascota["estado"];?></li>
				<li><?php echo $mascota["certificado"];?></li>
				<li><?php echo $mascota["description"];?></li>
			  </ul>
			  <div class="actions">
				<a href="/mensaje/new/<?php echo $mascota["mascota_uuid"];?>/<?php echo $mascotas["currentUser"][0]["uuid"];?>" class="add-cart">
				  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
					<g>
				...
				<a href="/pet/visita/<?php echo $mascota["mascota_uuid"];?>" class="add-compare">
				  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
		...
		<?php endif;?>
			...
			<!-- 	RESULTADOS ANIMALISTA -->

			<?php if(isset($animalistas)):?>
			<?php if(empty($animalistas)):?>
				<h3>No produjo resultados tu busqueda</h3>
			<?php endif;?>
			<?php foreach($animalistas as $key => $animalista):?>
			<div class="products grid row">
				<div class="col-sm-3 col-md-3 product rotation">
					<div class="default">
						<span class="sale top"></span>
						...
						<div class="product-description">
							<div class="vertical">
								<h3 class="product-name">
									<?php //print_r($mascota);die;?>
									<a href="shop-product-view.html"><?php echo $animalista["titulo_perfil"];?></a>
								</h3>
							</div>
						</div>
					</div>
					...
					<div class="product-hover">
						...
						<ul>
							<li><?php echo "Costo por noche: ".$animalista["costo_noche"];?></li>
							<li><?php echo "Costo por 8 hrs: ".$animalista["costo_ocho_hrs"];?>, </li>
							<li><?php echo "Paseo por 30 Min.: ".$animalista["paseos_30_min"];?></li>
							<li><?php echo "Sesion de entrenamiento: ".$animalista["session_entrenamiento"];?></li>
						</ul>
						<div class="actions">
							<a href="/mensaje/new/<?php echo $animalista["user_uuid"];?>/<?php echo $current[0]["uuid"];?>" class="add-cart">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
					<g>
						<path fill="#1e1e1e" d="M15.001,4h-0.57l-3.707-3.707c-0.391-0.391-1.023-0.391-1.414,0c-0.391,0.391-0.391,1.023,0,1.414L11.603,4
						H4.43l2.293-2.293c0.391-0.391,0.391-1.023,0-1.414s-1.023-0.391-1.414,0L1.602,4H1C0.448,4,0,4.448,0,5s0.448,1,1,1
				  ...
				  <path fill="#1e1e1e" d="M11.335,0C10.026,0,8.848,0.541,8,1.407C7.153,0.541,5.975,0,4.667,0C2.088,0,0,2.09,0,4.667C0,12,8,16,8,16
					...
					s2-2,3.334-2c1.47,0,2.666,1.196,2.666,2.667C14.001,9.321,9.867,12.49,8,13.684z"></path>
							...
							<a href="/user/visita/<?php echo $animalista["animalista_uuid"];?>" class="add-compare">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
					<path fill="#1e1e1e" d="M16,3.063L13,0v2H1C0.447,2,0,2.447,0,3s0.447,1,1,1h12v2L16,3.063z"></path>
									<path fill="#1e1e1e" d="M16,13.063L13,10v2H1c-0.553,0-1,0.447-1,1s0.447,1,1,1h12v2L16,13.063z"></path>
									<path fill="#1e1e1e" d="M15,7H3V5L0,7.938L3,11V9h12c0.553,0,1-0.447,1-1S15.553,7,15,7z"></path>
		...
		<div class="pagination-box">
		  ...
		  <i class="pagination-text">Mostrando 1 de 10 (de 100 resultados)</i>
		</div><!-- .pagination-box -->
      </div><!-- .content -->
