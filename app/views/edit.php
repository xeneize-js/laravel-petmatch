...
<head>
  <meta charset="utf-8">
  <title>My Account \ Progressive — Responsive Multipurpose HTML Template</title>
		  ...
		  <div class="navbar navbar-inverse top-navbar top-navbar-right" role="navigation">
			...
			<nav class="collapse collapsing navbar-collapse">
			  <ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#"><i class="fa fa-heart"></i> M</a></li>
				<li><a href="#">My Cart <span class="count">2</span></a></li>
				<li><a href="#">Checkout</a></li>
				<li><a href="/user/logout">Logout <i class="fa fa-lock after"></i></a></li>
			  </ul>
			</nav>
		  </div>
		</div>
			  ...
			  --><div class="btn-group cart-header">
				...
				<div class="dropdown-menu">
				  ...
				  <ul class="list-unstyled">
					<li>
					  <a href="shop-product-view.html" class="product-image"><img src="/img/content/product-1.png" width="70" height="70" alt=""></a>
					...
					<li>
					  <a href="shop-product-view.html" class="product-image"><img src="img/content/product-2.png" width="70" height="70" alt=""></a>
					  <a href="#" class="product-remove">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="16px" height="16px" viewBox="0 0 16 16" enable-background="new 0 0 16 16" xml:space="preserve">
						  <g>
							<path d="M6,13c0.553,0,1-0.447,1-1V7c0-0.553-0.447-1-1-1S5,6.447,5,7v5C5,12.553,5.447,13,6,13z"></path>
				  ...
				  <ul class="nav navbar-nav navbar-center">
					<li class="parent">
					  ...
					  <ul class="sub">
						...
						<li><a href="home-5.html">Animation (Retina)<span class="item-new">New</span></a></li>
						<li class="parent">
...
<section id="main">
  ...
  <div class="container">
    <div class="row">
	       <div class="content col-sm-12 col-md-12">	<div class="my-account">
		  <div class="bottom-padding">
			<p class="hello"><strong>¡Hola <?php echo $user[0]["nombre"];?></strong></p>
			<p>
<div class="tabs">
		  <ul class="nav nav-tabs">
			<li class="active">
			  <a href="#services" data-toggle="tab"><i class="fa fa-heart"></i> Bienvenido</a>
			</li>
			<li>
			  <a href="#features" data-toggle="tab"><i class="fa fa-share-check"></i> Consejos</a>
			</li>
			<li>
			  <a href="#text" data-toggle="tab"><i class="fa fa-folder-question"></i> Ayuda</a>
			</li>
		  </ul>
		  <div class="tab-content">
			<div class="tab-pane active fade in" id="services">
			  <div class="service">
				<a href="#" class="icon bg"><i class="fa fa-user"></i></a>
				<h6 class="title"><a href="#">¡Hola!</a></h6>
				<div class="text-small">Bienvenido a tu panel de control, aquí podras actualizar tus datos personales, de contacto, suscripción y otras cosas más.</div>
			  </div>
			  <hr>
			  <div class="service">
			...
			<div class="tab-pane fade in" id="text">
			  ...
			  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus cumque ad ea asperiores architecto aperiam consectetur. Modi quasi ex non hic ad a blanditiis molestiae alias corporis quo molestias ipsum!</p>
			  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi perferendis iusto fugit! Molestias rerum sit doloribus ut cum facere et eius atque eos sint hic consequatur ullam culpa reprehenderit qui reiciendis dolor quae nostrum officiis aperiam quibusdam delectus iusto iste aliquid non maxime voluptatem illum temporibus velit rem! Incidunt praesentium eos sunt totam minus pariatur modi cupiditate ipsam nihil soluta.</p>
			</div>
		  </div>
		</div>
	  </div></p>
          			...
          			<p class="hello"><strong>¡Mejora la experiencia!¡Invita a tus amigos!</strong></p>
		...
		<div class="col-sm-4 col-md-4 service">
		  ...
		  <div class="steps">
		  <div class="step border-warning bg-warning white">
			<div class="step-wrapper">
			  <div class="title-box title-white">
				<h4 class="title">Administración</h4>
			  </div>
			  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam perferendis fugiat consequuntur eveniet enim atque eos quis. Dolores nulla rem quas sapiente obcaecati suscipit similique! Quam consectetur laborum.</p>
			</div>
		  </div>
		  <div class="step text-center border-info bg-info white">
			<div class="step-wrapper">
			  <span class="livicon" data-n="settings" data-s="48" data-c="#fff" data-hc="#f6f5f5"></span>
			  <div class="title-box text-center title-white">
				<h4 class="title">Mi Perfil.</h4>
			  </div>
			  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia sapiente pariatur dolores neque corporis adipisci.</p>
			</div>
		  </div>
		  <div class="step text-center border-error bg-error white">
			<div class="step-wrapper">
			  <span class="livicon" data-n="key" data-s="62" data-c="#fff" data-hc="#f6f5f5"></span>
			  <div class="title-box text-center title-white">
		  ...
		  <div class="step text-center border-success bg-success white">
			<div class="step-wrapper">
			  <span class="livicon" data-n="magic" data-c="#fff" data-hc="#f6f5f5" data-s="64"></span>
			  <div class="title-box text-center title-white">
				<h4 class="title">Mi Suscripción</h4>
			  </div>
			  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia sapiente pariatur dolores neque corporis adipisci.</p>
			</div>
		  </div>
